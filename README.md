...
> Демонстрация работы бота и меню:
...
- 🧾 **900+ строк кода** — полноценное приложение, а не демо
- 🗄️ **Работа с базой данных** (SQLite + aiosqlite)
- 🔐 **Ролевая модель**: доступ только админам
- 🧭 **Навигация через кнопки** + понятные подсказки
- 📦 **Склады и товары** с удобной структурой
- ⚙️ **FSM‑сценарии** для пошагового ввода
- 📥 **Массовая загрузка** через CSV
- 📤 **Экспорт CSV** остатков
- 🧾 **История движений** для контроля изменений
